...
@Component({
  selector: 'app-std-six-io-dashboard',
  templateUrl: './std-six-io-dashboard.component.html',
  styleUrls: ['./std-six-io-dashboard.component.scss']
})
export class StdSixIoDashboardComponent implements OnInit {
